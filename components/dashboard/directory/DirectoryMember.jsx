...
import DirectoryMemberModal from "./DirectoryMemberModal";
import { useMemberInfo } from "../../../context/GlobalContext";

export default function DirectoryMember({
  newProfile,
  setNewProfile,
  newDirectory,
  setNewDirectory,
  ...
  const {currentMember, setCurrentMember} = useMemberInfo();
  ...
  function eliminarMiembro(id) {
    ...
    const eliminado = newDirectory.filter((member) => member.id !== id);
    console.log(eliminado);
    // console.log(eliminado)
    setNewDirectory(eliminado);
    setNewProfile([])
      ...
      <article>
            ...
            <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
              ...
              <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                ...
                <div className="justify-stretch mt-6 flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                  ...
                  <button
                    onClick={() => eliminarMiembro(currentMember.id)}
                    type="button"
                    className="inline-flex justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
                  >
                    <PhoneIcon
        ...
        <div className="mx-auto mt-6 max-w-5xl px-4 sm:px-6 lg:px-8">
          <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            {Object.keys(member.fields).map((field) => (
